package com.judecodes.codegenerator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        String url = "jdbc:mysql://127.0.0.1:3306/my_mail?useSSL=false&serverTimezone=Asia/Shanghai";
        String username = "root";
        String password = "123456";
        // 当前这个 CodeGenerator 模块的根路径
        String projectPath = "D:/CodeData/myProject/myMail/CodeGenerator";
...
//                            .enableSwagger() // 开启 swagger 模式
                ...
                .packageConfig(builder -> builder
                        ...
                        .parent("com.judecodes.codegenerator")
                        .entity("entity")
                        .mapper("mapper")
                        .service("service")
                ...
                .strategyConfig(builder -> builder
                        // 只生成 tz_user 表
                        .addInclude("tz_user_operate_stream")
