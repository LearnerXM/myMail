create table if not exists mail.cms_help
(
    ...
    comment '帮助表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_help_category
(
    id          bigint auto_increment
    primary key,
    ...
    comment '帮助分类表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_member_report
(
    id                 bigint       null,
    ...
    comment '用户举报表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_prefrence_area
(
    id          bigint auto_increment
    primary key,
    ...
    comment '优选专区' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_prefrence_area_product_relation
(
    id                bigint auto_increment
    primary key,
    ...
    comment '优选专区和产品关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_subject
(
    id               bigint auto_increment
    primary key,
    category_id      bigint        null,
...
create table if not exists mail.cms_subject_category
(
    id            bigint auto_increment
    primary key,
    name          varchar(100) null,
    ...
    comment '专题分类表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_subject_comment
(
    id               bigint auto_increment
    primary key,
    ...
    comment '专题评论表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_subject_product_relation
(
    id         bigint auto_increment
    primary key,
    subject_id bigint null,
    ...
    comment '专题商品关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_topic
(
    id              bigint auto_increment
    primary key,
    category_id     bigint       null,
    ...
    comment '话题表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_topic_category
(
    id            bigint auto_increment
    primary key,
    name          varchar(100) null,
    ...
    comment '话题分类表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.cms_topic_comment
(
    id               bigint auto_increment
    primary key,
    member_nick_name varchar(255)  null,
...
create table if not exists mail.oms_cart_item
(
    id                  bigint auto_increment
    primary key,
    product_id          bigint         null,
    ...
    comment '购物车表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.oms_company_address
(
    id             bigint auto_increment
    primary key,
    ...
    comment '公司收发货地址表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.oms_order
(
...
create table if not exists mail.oms_order_item
(
    id                  bigint auto_increment
    primary key,
    ...
    comment '订单中所包含的商品' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.oms_order_operate_history
(
    id           bigint auto_increment
    primary key,
    order_id     bigint       null comment '订单id',
    ...
    comment '订单操作历史记录' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.oms_order_return_apply
(
    id                 bigint auto_increment
    primary key,
    order_id           bigint         null comment '订单id',
    ...
    comment '订单退货申请' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.oms_order_return_reason
(
    id          bigint auto_increment
    primary key,
    ...
    comment '退货原因表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.oms_order_setting
(
    id                    bigint auto_increment
    primary key,
    ...
    comment '订单设置表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_album
(
    id          bigint auto_increment
    primary key,
    ...
    comment '相册表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_album_pic
(
    id       bigint auto_increment
    primary key,
    ...
    comment '画册图片表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_brand
(
    id                    bigint auto_increment
    primary key,
    name                  varchar(64)  null,
    ...
    comment '品牌表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_comment
(
    id                bigint auto_increment
    primary key,
    product_id        bigint        null,
    ...
    comment '商品评价表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_comment_replay
(
    id               bigint auto_increment
    primary key,
    ...
    comment '产品评价回复表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_feight_template
(
    id              bigint auto_increment
    primary key,
    name            varchar(64)    null,
    ...
    comment '运费模版' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_member_price
(
    id                bigint auto_increment
    primary key,
    product_id        bigint         null,
    ...
    comment '商品会员价格表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product
(
    id                            bigint auto_increment
    primary key,
...
create table if not exists mail.pms_product_attribute
(
    id                            bigint auto_increment
    primary key,
    product_attribute_category_id bigint       null,
    ...
    comment '商品属性参数表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_attribute_category
(
    id              bigint auto_increment
    primary key,
    name            varchar(64)   null,
    ...
    comment '产品属性分类表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_attribute_value
(
    id                   bigint auto_increment
    primary key,
    product_id           bigint      null,
    ...
    comment '存储产品参数信息的表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_category
(
    id            bigint auto_increment
    primary key,
    ...
    comment '产品分类' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_category_attribute_relation
(
    id                   bigint auto_increment
    primary key,
    product_category_id  bigint null,
    ...
    comment '产品的分类和属性的关系表，用于设置分类筛选条件（只支持一级分类）' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_full_reduction
(
    id           bigint auto_increment
    primary key,
    product_id   bigint         null,
    ...
    comment '产品满减表(只针对同商品)' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_ladder
(
    id         bigint auto_increment
    primary key,
    product_id bigint         null,
    ...
    comment '产品阶梯价格表(只针对同商品)' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_product_operate_log
(
    id                  bigint auto_increment
    primary key,
    product_id          bigint         null,
...
create table if not exists mail.pms_product_vertify_record
(
    id          bigint auto_increment
    primary key,
    product_id  bigint       null,
    ...
    comment '商品审核记录' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.pms_sku_stock
(
    id              bigint auto_increment
    primary key,
    product_id      bigint         null,
    ...
    comment 'sku的库存' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_coupon
(
    id            bigint auto_increment
    primary key,
    type          int            null comment '优惠券类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券',
    name          varchar(100)   null,
...
create table if not exists mail.sms_coupon_history
(
    id              bigint auto_increment
    primary key,
    coupon_id       bigint       null,
    ...
    comment '优惠券使用、领取历史表' charset = utf8mb3
    row_format = DYNAMIC;

create index idx_coupon_id
    on mail.sms_coupon_history (coupon_id);

create index idx_member_id
    on mail.sms_coupon_history (member_id);

create table if not exists mail.sms_coupon_product_category_relation
(
    id                    bigint auto_increment
    primary key,
    coupon_id             bigint       null,
    ...
    comment '优惠券和产品分类关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_coupon_product_relation
(
    id           bigint auto_increment
    primary key,
    coupon_id    bigint       null,
    ...
    comment '优惠券和产品的关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_flash_promotion
(
    id          bigint auto_increment
    primary key,
    title       varchar(200) null comment '秒杀时间段名称',
    start_date  date         null comment '开始日期',
    end_date    date         null comment '结束日期',
    status      int          null comment '上下线状态',
    create_time datetime     null comment '创建时间'
    )
    comment '限时购表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_flash_promotion_log
(
    ...
    comment '限时购通知记录' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_flash_promotion_product_relation
(
    ...
    comment '商品限时购与商品关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_flash_promotion_session
(
    id          bigint auto_increment comment '编号'
    primary key,
    ...
    comment '限时购场次表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_home_advertise
(
    id          bigint auto_increment
    primary key,
    name        varchar(100)  null,
    ...
    comment '首页轮播广告表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_home_brand
(
    id               bigint auto_increment
    primary key,
    brand_id         bigint      null,
    ...
    comment '首页推荐品牌表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_home_new_product
(
    id               bigint auto_increment
    primary key,
    product_id       bigint       null,
    ...
    comment '新鲜好物表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_home_recommend_product
(
    id               bigint auto_increment
    primary key,
    product_id       bigint       null,
    ...
    comment '人气推荐商品表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.sms_home_recommend_subject
(
    id               bigint auto_increment
    primary key,
    subject_id       bigint      null,
    ...
    comment '首页推荐专题表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_admin
(
    id          bigint auto_increment
    primary key,
...
create table if not exists mail.ums_admin_login_log
(
    id          bigint auto_increment
    primary key,
    ...
    comment '后台用户登录日志表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_admin_permission_relation
(
    id            bigint auto_increment
    primary key,
    admin_id      bigint null,
...
create table if not exists mail.ums_admin_role_relation
(
    id       bigint auto_increment
    primary key,
    admin_id bigint null,
    ...
    comment '后台用户和角色关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_growth_change_history
(
    id           bigint auto_increment
    primary key,
    member_id    bigint       null,
    ...
    comment '成长值变化历史记录表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_integration_change_history
(
    id           bigint auto_increment
    primary key,
    member_id    bigint       null,
    ...
    comment '积分变化历史记录表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_integration_consume_setting
(
    id                    bigint auto_increment
    primary key,
    ...
    comment '积分消费设置' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member
(
    id                     bigint auto_increment
    primary key,
    member_level_id        bigint       null,
...
create table if not exists mail.ums_member_level
(
    id                      bigint auto_increment
    primary key,
    name                    varchar(100)   null,
...
create table if not exists mail.ums_member_login_log
(
    id          bigint auto_increment
    primary key,
    member_id   bigint      null,
    ...
    comment '会员登录记录' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_member_tag_relation
(
    id        bigint auto_increment
    primary key,
    member_id bigint null,
    ...
    comment '用户和标签关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_product_category_relation
(
    id                  bigint auto_increment
    primary key,
    member_id           bigint null,
    ...
    comment '会员与产品分类关系表（用户喜欢的分类）' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_receive_address
(
    id             bigint auto_increment
    primary key,
    member_id      bigint       null,
    ...
    comment '会员收货地址表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_rule_setting
(
    id                  bigint auto_increment
    primary key,
    ...
    comment '会员积分成长规则表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_statistics_info
(
    id                    bigint auto_increment
    primary key,
    member_id             bigint         null,
    ...
    comment '会员统计信息' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_tag
(
    id                  bigint auto_increment
    primary key,
    name                varchar(100)   null,
    ...
    comment '用户标签表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_member_task
(
    id           bigint auto_increment
    primary key,
    name         varchar(100) null,
    ...
    comment '会员任务表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_menu
(
    id          bigint auto_increment
    primary key,
    ...
    comment '后台菜单表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_permission
(
    id          bigint auto_increment
    primary key,
...
create table if not exists mail.ums_resource
(
    id          bigint auto_increment
    primary key,
    create_time datetime     null comment '创建时间',
    ...
    comment '后台资源表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_resource_category
(
    id          bigint auto_increment
    primary key,
    create_time datetime     null comment '创建时间',
    ...
    comment '资源分类表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_role
(
    id          bigint auto_increment
    primary key,
    name        varchar(100)  null comment '名称',
    ...
    comment '后台用户角色表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_role_menu_relation
(
    id      bigint auto_increment
    primary key,
    ...
    comment '后台角色菜单关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_role_permission_relation
(
    id            bigint auto_increment
    primary key,
    role_id       bigint null,
    ...
    comment '后台用户角色和权限关系表' charset = utf8mb3
    row_format = DYNAMIC;

create table if not exists mail.ums_role_resource_relation
(
    id          bigint auto_increment
    primary key,
    role_id     bigint null comment '角色ID',
    ...
    comment '后台角色资源关系表' charset = utf8mb3
    row_format = DYNAMIC;
