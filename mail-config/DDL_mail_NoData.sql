...
(
    ...
    lock_version int        default 0                 not null comment '版本号'
    )
...
(
    ...
    lock_version           int          null comment '乐观锁版本号',
...
create table if not exists ums_notice
(
    id                bigint unsigned auto_increment comment 'ID（自增主键）'
    primary key,
    create_time       datetime                     null comment '创建时间',
    update_time       datetime                     null comment '创建时间',
    notice_title      varchar(512) charset utf8mb3 null comment '通知标题',
    notice_content    text charset utf8mb3         null comment '通知内容',
    notice_type       varchar(128) charset utf8mb3 null comment '通知类型',
    send_success_time datetime                     null comment '发送成功时间',
    target_address    varchar(256) charset utf8mb3 null comment '接收地址',
    ...
    sms_type          varchar(32)                  not null comment '短信类型：AUTH-认证授权；PASSWORD_CHANGE-密码修改'
    )
    comment '通知表';
