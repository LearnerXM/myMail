...
import com.judecodes.mailbase.response.ResponseCode;
import com.judecodes.mailbase.utils.BeanValidator;
...
public class FacadeAspect {
    ...
    @Around("@annotation(com.judecodes.mailrpc.facade.Facade)")
